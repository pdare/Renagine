...
struct Vertex {
    ...
    static std::array<VkVertexInputBindingDescription, 3> getAttributeDescriptions() {
...
class Renderer {
    ...
    private:
        ...
        void createImage();
        void transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint16_t mipLevels);
